...
El notebook carga automáticamente plans.csv, users_latam.csv y usage.csv desde /datasets/.
Librerías necesarias: pandas, seaborn, matplotlib (preinstaladas en Colab).
